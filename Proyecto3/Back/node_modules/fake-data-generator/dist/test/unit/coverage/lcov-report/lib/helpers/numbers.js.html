...
<head>
    <title>Code coverage report for lib/helpers/numbers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">lib/helpers</a> numbers.js</h1>
        <div class='clearfix'>
...
&nbsp;
const incrementNumber = (value, { index, from = <span class="branch-0 cbranch-no" title="branch not covered" >0 }) =&gt; {</span>
  return from + index
}
&nbsp;
export {
