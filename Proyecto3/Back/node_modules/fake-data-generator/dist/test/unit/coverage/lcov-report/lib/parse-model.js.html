...
<head>
    <title>Code coverage report for lib/parse-model.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> parse-model.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">3x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import faker from 'faker'
...
const modelAttributeTypes = {
  ...
  // -- external libs
  faker: (args, options = <span class="branch-1 cbranch-no" title="branch not covered" >{}) =&gt; O</span>bject.byString(faker, args)(...options),
  // -- internal libs
  // ---- strings
  append,
  prepend,
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Wed Mar 31 2021 11:21:46 GMT-0300 (Argentina Standard Time)
            </div>
        </div>
