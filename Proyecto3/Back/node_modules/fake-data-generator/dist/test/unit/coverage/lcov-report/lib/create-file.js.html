...
<head>
    <title>Code coverage report for lib/create-file.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">lib</a> create-file.js</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >        throw n</span>ew Error(err)
      }
      console.log('\x1b[32m', `Your file has been saved in ${process.cwd()}/output/${fileName}.`);
    });
  }
  catch (err) {
<span class="cstat-no" title="statement not covered" >    console.e</span>rror(err)
  }
}
&nbsp;</pre></td></tr></table></pre>
